...
- 4.3.1	-> Netgroup -> Show all netgroups
	...
	...
	dn: cn=all_se,ou=Netgroup,dc=unix,dc=example,dc=nl
	dn: cn=all_wi,ou=Netgroup,dc=unix,dc=example,dc=nl
	dn: cn=all_ws,ou=Netgroup,dc=unix,dc=example,dc=nl
...
- 4.4	-> Transactions
	...
	Type: The type of modification made. E.g. add_grp (a unix group is
	added), multiple_user_add (a bunch of users was created) etc...
	...
	------------------------------------------------------------------
	1363183419  Bijvak  Wed Mar 13 15:03 2013 multiple_user_add done
	1363183419  Bijvak  Wed Mar 13 15:03 2013 multiple_user_add undo
	1363178314  Student Wed Mar 13 13:38 2013 multiple_user_add done
	1363178314  Student Wed Mar 13 13:38 2013 multiple_user_add undo
...
- 5.3.5	-> Netgroup -> Link entity to netgroup -> Netgroup to netgroup
	...
	Enter parent netgroup:  [all_wi]
	Enter child netgroup:   [ws_staf]
